...
- **Atualização do Hub**: Sempre que alterar ou atualizar o arquivo `meli_hub.user.js`, certifique-se de incrementar a constante `HUB_VERSION` no código e a propriedade `hub_version` no arquivo `manifest.json`.
